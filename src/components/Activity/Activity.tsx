...
export const Activity = ({ gameImageUrl, name, onClick }: ActivityProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-gradient-to-b duration-300 flex flex-col from-transparent via-pink-500/10 to-pink-900/70 h-full rounded-md group-hover:rounded-b-none transition-all w-full">
          <div
      ...
      <div className="absolute bg-pink-500 bottom-0 duration-300 font-round2 font-semibold h-8 p-1 rounded-b text-white text-center transition-all translate-y-full group-hover:translate-y-0 w-full">
        {t("viewDetails")}
      </div>
    </div>
  );
