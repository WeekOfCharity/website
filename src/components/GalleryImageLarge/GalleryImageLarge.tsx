  ...
  return (
    <div className="fullscreenPopUp" onClick={handlePopUpClick}>
        <div className="largeImageWrapper bg-neutral-800">
            ...
            <img src={(process.env.NODE_ENV === 'production' ? 'https://directus.weekofcharity.de' : 'http://localhost:8055') + `/assets/${imageData.image}?q=75&format=webp`} className="largeImage" />
