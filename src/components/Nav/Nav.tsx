  ...
  return (
    <nav className="flex items-center p-5 md:p-10 select-none sticky text-neutral-800 top-0 w-full z-[99999]">
      ...
      <menu className="md:flex hidden items-center ml-auto space-x-5">
        <NavLink
          className={({ isActive }) =>
            classNames(isActive ? 'text-persian-500' : 'hover:text-persian-500')
          }
          to="/"
        >
        ...
        <NavLink
          className={({ isActive }) =>
            classNames(isActive ? 'text-aqua-500' : 'hover:text-aqua-500')
          }
          to="/program"
        >
        ...
        <NavLink
          className={({ isActive }) =>
            classNames(isActive ? 'text-arctic-500' : 'hover:text-arctic-500')
          }
          to="/games"
        >
        ...
        <NavLink
          className={({ isActive }) =>
            classNames(
              isActive ? 'text-lavender-500' : 'hover:text-lavender-500'
            )
          }
          to="/team"
        >
      ...
      >
        ...
        <menu className="flex flex-col space-y-5 text-white">
          <NavLink
            className={({ isActive }) =>
              classNames(
                isActive ? 'text-persian-500' : 'hover:text-persian-500'
              )
            }
            onClick={() => setMenuOpen(false)}
            to="/"
