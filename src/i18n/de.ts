...
export const deTranslation: Translation = {
  ...
  activities: {
    ...
    mainHeader: "Die Aktivitäten der", // Week of Charity
    joinTheseStreams: "Sei dabei in diesen Streams",
    isHostedBy: "wird gehostet von",
    isAccompaniedBy: "wird begleitet von",
  },
  gallery: {
    subHeader: "Von euch und uns",
  ...
  home: {
    upcomingText: "Wir streamen wieder für den guten Zweck",
    runningText: "Wir streamen wieder für den guten Zweck",
    endedText: "Danke fürs Dabeisein",
    subHeader: "Neues Jahr, neue Woche",
    countdown: {
      days: "Tage",
      hours: "Stunden",
      minutes: "Minuten",
    ...
    weAreBehindIt1: "Wir stecken",
    weAreBehindIt2: "dahinter",
    participants: "Teilnehmer und Helfer",
  ...
  program: {
    subHeader: "Keine Events verpassen",
  ...
  projects: {
    subHeader: "Über uns",
    mainHeader: "Die Week of Charity",
    text: {
  ...
  team: {
    subHeader: "Helfende und Freunde",
    mainHeader: "Das Team der", // Week of Charity
    weStream: "Wir streamen für euch",
    weSupport: "Wir unterstützen und begleiten",
  ...
  goals: {
    ...
    tbd: "Termin steht noch aus",
    secret: "Dieses Spendenziel ist noch geheim",
  },
  bidwar: {
    vote: "Stimmt ab mit Euren Spenden",
    result: "Endergebnis",
  },
  donationMeter: {
    current: "Aktueller",
    amount: "Spendenstand",
    donationTarget: "aktuelles Spendenziel",
    allTargetsReached: "Alle Ziele wurden erreicht!",
  },
  player: {
    currentStream: "Aktueller Stream",
    notActive1: "Die Week of Charity ist aktuell nicht aktiv.",
    notActive2: "Sieh dir unser Programm an, um keine Events zu verpassen.",
    loading: "Aktueller Stream wird geladen...",
    watchNow: "jetzt zusehen",
  },
  and: "und",
  clickForMoreInfo: "Klick uns an für mehr Infos",
  seeMoreSoon: "Bald seht ihr hier mehr!",
