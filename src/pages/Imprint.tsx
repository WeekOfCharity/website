  ...
  return (
    <main className="text-neutral-800 woc-accent-neutral">
      <header className="px-5 py-20 relative text-center">
        <div className="font-pally font-bold max-w-screen-md mx-auto text-accent-500 text-4xl md:text-7xl w-4/5">Impressum</div>
      ...
      <section className="max-w-screen-2xl mb-20 md:mb-40 mt-12 md:mt-20 mx-auto px-4 md:px-10 2xl:px-2.5 space-y-2 text-justify">
        <div className="font-round2 font-bold uppercase">Angaben gemäß § 5 TMG</div>
        <p>
          Sven Gohlke
          <br />
          Rosenallee 26
        ...
        <div className="font-round2 font-bold pt-6 text-xl">Haftungsausschluss:</div>

        <div className="font-round2 font-bold uppercase">Haftung für Inhalte</div>
        <p>
          ...
          übernehmen. Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10 TMG sind
          wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach Umständen zu forschen, die auf eine
          rechtswidrige Tätigkeit hinweisen. Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unberührt.
