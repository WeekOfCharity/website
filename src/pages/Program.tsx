  ...
  return (
    <main className="text-neutral-800 woc-accent-green23">
      ...
      <section className="max-w-screen-2xl mb-20 md:mb-40 mt-12 md:mt-20 mx-auto px-4 md:px-10 2xl:px-2.5">
        <div className="font-semibold mb-6 text-3xl md:text-4xl text-center md:text-left">{streamsStatus === 'success' && streams.length > 0 ? "Alle Streams" : "Bald seht ihr hier mehr!"}</div>
