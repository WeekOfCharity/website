    ...
    <main className="text-neutral-800 woc-accent-persian">
      ...
      <div className="max-w-screen-2xl mt-5 mb-40 mx-auto flex place-content-center">
        <div className="max-w-screen-xl flex flex-col items-center mx-10 md:mx-28 lg:mx-32">
          <section className="max-w-screen-lg mx-0 sm:mx-8 lg:mx-16 flex bg-persian-100 bg-opacity-50 py-10 row-span-2">
            <div>
              <div className="leading-relaxed mx-5 md:mx-10 text-left">
                ...
                abgehalten. Was wann wo zu sehen ist, findet ihr in unserem <a href="/streams" className="cursor-pointer text-persian-500">Zeitplan</a>. <br /><br />
            ...
            <div className="card-container">
              <div className="card bg-persian-100 bg-opacity-50">
                ...
                <div className="leading-relaxed py-5 pl-5 md:pl-8 pr-5 text-left">
                  ...
                  <p>
                    Für den dritten Durchlauf gehen alle unsere Spenden dieses Jahr an das <a target="_blank" href="https://tierschutz-berlin.de/" className="cursor-pointer text-persian-500">Tierheim Berlin</a>.
              ...
              <div className="card bg-persian-100 bg-opacity-50">
                ...
                <div className="leading-relaxed py-5 pr-5 md:pr-8 pl-5 text-right">
                  ...
                  <p>
                    Für unsere zweite Runde haben wir 2022 das LGBTQ+ Jugendwohnheim "<a target="_blank" href="https://www.godesheim.de/angebote/queere-vielfalt-leben/" className="cursor-pointer text-persian-500">Queere Vielfalt leben</a>" in Köln unterstützt.
